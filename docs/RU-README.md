...
Последнее обновление 2.2.1
--------------------------

 * **Interval.parseInterval** - Теперь в качестве аргумента можно использовать строку с числом.
 * **Interval.period** - Теперь можно использовать числовое представление для начала или конца периода.
