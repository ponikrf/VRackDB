...
var _Collector_instances, _Collector_mectrics, _Collector_findLayers, _Collector_findLayer;
...
_Collector_mectrics = new WeakMap(), _Collector_instances = new WeakSet(), _Collector_findLayers = function _Collector_findLayers(name, start, end, precision) {
    const result = [];
    let nextStart = start;
