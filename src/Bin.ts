...
export default class Bin {
    ...
    */
    static getIndexByte(index: number) {
     ...
     * @return {number} The index bit
    */
    static getIndexBit(index: number) {
        return (index % 8)
    }
    ...
    */
    static getBit(byte: number, bit = 0): number {
        return (byte >> bit) & 1;
    }
    ...
    */
    static setBit(byte: number, bit = 0): number {
        return byte | (1 << bit);
    }
    ...
    */
    static clearBit(byte: number, bit = 0): number {
        return byte & (~(1 << bit));
    }
